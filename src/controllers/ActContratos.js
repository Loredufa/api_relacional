  ...
  try {
    ...
    const jsonNewData = jsonData.map((el) => {
      return {
        ...
        cuo_sin_int : el.CON_CUO_SIN_INT? el.CON_CUO_SIN_INT.toString() : '',
        valor_contado: el.CON_VALOR_CONTADO ? el.CON_VALOR_CONTADO.toString() : '',
        cuo_fija_ipc : el.CON_CUO_FIJA_IPC? el.CON_CUO_FIJA_IPC.toString() : '',
        saldo_ipc : el.CON_SALDO_IPC? el.CON_SALDO_IPC.toString() : '',
